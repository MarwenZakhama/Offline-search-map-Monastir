...
- **Main roads are light yellow**; every other road class, the railway and the boundaries use the map's normal colours. Change the colour in `osmRoadColors` inside `mapstyle.js` if you want a different shade.
